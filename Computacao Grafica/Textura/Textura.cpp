...
void drawCube()
{
	...
	glBegin(GL_QUADS);
	{
		...
		glVertex3f(1.0f, -1.0f, 1.0f);
		glTexCoord2f(1.0f, 0.68f);
		glVertex3f(1.0f, 1.0f, 1.0f);
		glTexCoord2f(0.49f, 0.68f);
		glVertex3f(-1.0f, 1.0f, 1.0f);

		// Face fundo - 2
		glTexCoord2f(0.49f, 0.67f);
		glVertex3f(-1.0f, -1.0f, -1.0f);
		...
		glTexCoord2f(0.49f, 0.68f);
		glVertex3f(-1.0f, 1.0f, 1.0f);
		glTexCoord2f(0.0f, 0.68f);
		glVertex3f(-1.0f, 1.0f, -1.0f);

		// Face lateral direita - 5
		glTexCoord2f(0.0f, 0.0f);
		glVertex3f(1.0f, -1.0f, -1.0f);
		glTexCoord2f(0.5f, 0.0f);
		glVertex3f(1.0f, 1.0f, -1.0f);
		glTexCoord2f(0.5f, 0.34f);
		glVertex3f(1.0f, 1.0f, 1.0f);
		glTexCoord2f(0.0f, 0.34f);
		glVertex3f(1.0f, -1.0f, 1.0f);
	}
